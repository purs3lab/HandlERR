...
// lengths. For example: Consider the expression: (x & y) Here, it is unlikely
// that variables x and y cannot be length variables because it is hard to
// imaging a variable used as length used in a bitwise AND.
