...
// unwritable-expected-warning@+2 {{0 unchecked pointers: Declaration in non-writable file}}
...
// unwritable-expected-warning@+1 {{0 unchecked pointers: Declaration in non-writable file}}
void *x; // expected-warning {{1 unchecked pointer: Default void* type}}

void test0() {
  // unwritable-expected-warning@+1 {{0 unchecked pointers: Declaration in non-writable file}}
  int *a;
  // unwritable-expected-warning@+1 {{0 unchecked pointers: Expression in non-writable file}}
  char *b;
  // unwritable-expected-warning@+2 {{0 unchecked pointers: Expression in non-writable file}}
...
void test1() {
  ...
  void (*c)(void); // unwritable-expected-warning {{0 unchecked pointers: Declaration in non-writable file}}
