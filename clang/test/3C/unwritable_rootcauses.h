...
int arr[] = {1,2,3,4};// unwritable-expected-warning {{1 unchecked pointer: Source code in non-writable file}}  // unwritable-expected-warning {{1 unchecked pointer: Source code in non-writable file}}
