...
bool PointerVariableConstraint::emitArraySize(deque<std::string> &EndStrs,
                                              uint32_t TypeIdx, bool &EmitName,
...
PointerVariableConstraint::mkString(EnvironmentMap &E,
  ...
  for (; It != vars.end(); ++It) {
    ...
    PrevArr = (K == Atom::A_Arr && ArrPresent
  ...
  // TODO: I want to get rid of this string comparison to RETVAR
